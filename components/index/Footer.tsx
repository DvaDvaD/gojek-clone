const Footer = () => {
	return (
		<footer className="bg-[#101820] py-20">
			<style jsx>
				{`
					p:not(first-child) {
						margin-top: 16px;
			...
			<div className="mx-auto flex max-w-[70rem] flex-wrap">
				...
				<div className="flex w-9/12">
					<div className="w-1/4">
						<h4 className="mb-6 text-xl font-[500]">Perusahaan</h4>
						<p>Tentang</p>
						<p>Produk</p>
						<p>Blog</p>
					</div>
					<div className="w-1/4">
						<h4 className="mb-6 text-xl font-[500]">Gabung</h4>
						<p>Mitra Driver</p>
						<p>Mitra Usaha</p>
					</div>
					<div className="w-1/4">
						<h4 className="mb-6 text-xl font-[500]">Karir</h4>
						<p>Pelajar</p>
						<p>Profesional</p>
					</div>
					<div className="w-1/4">
						<h4 className="mb-6 text-xl font-[500]">Hubungi Kami</h4>
						<p>Bantuan</p>
						<p>Lokasi Kami</p>
					</div>
				</div>
				<div className="w-3/12">
					<h4 className="mb-4 text-lg font-[500]">Cari tau berita terbaru</h4>
					<div className="flex space-x-10">
						{Array(4)
							.fill("")
							.map((_, idx) => (
								<div
									className="aspect-square h-auto w-10 rounded-full bg-white"
									key={idx}
								></div>
							))}
					</div>
					<div className="mt-12">
						<h4 className="mb-4 text-lg font-[500]">Unduh aplikasi</h4>
						<div className="flex space-x-10">
							{Array(2)
								.fill("")
								.map((_, idx) => (
				...
				<hr className="my-12 w-full border-gray-600" />
				<div className="w-full">
					<div className="mt-10">
						<p className="text-center text-[15px]">
							© 2023 Gojek | Gojek adalah merek milik PT GoTo Gojek Tokopedia
